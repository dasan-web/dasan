  ...
  return (
    <div className="relative max-w-4xl mx-auto z-10">
      ...
      {timelineData.map((era, reversedIndex) => {
        ...
        return (
          <div key={reversedIndex} className="mb-12 md:mb-14 last:mb-0 relative group">
            {/* Era Header */}
            <motion.div 
            ...
            >
              ...
              <div 
                className="ml-[60px] md:ml-[160px] bg-brand-green/5 border border-brand-green/20 px-5 py-2.5 rounded-2xl flex items-center flex-wrap animate-fade-in-up" 
