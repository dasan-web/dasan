...
const CAREER_ROLES: CareerRole[] = [
  {
    ...
    categoryKo: '연구개발',
    categoryEn: 'R&D',
    workplaceKo: '중앙연구소 (수원)',
    workplaceEn: 'Central R&D Center (Suwon)',
    qualificationKo: '약학, 화학, 생명공학, 유기합성 등 이공계 학사·석사·박사',
    qualificationEn: 'B.S., M.S., Ph.D. in Pharmacy, Chemistry, Bioengineering, etc.',
    badgesKo: ['신입 / 경력', '연구개발', '경기 수원', '약학·화학·생명공학 석·박사 및 학사'],
    badgesEn: ['Entry / Experienced', 'R&D', 'Suwon', 'B.S., M.S., Ph.D.'],
    detailsKo: [
