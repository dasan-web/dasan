...
export default function PhilosophyGraphic() {
  ...
  return (
    <div className="relative w-full max-w-[320px] sm:max-w-[450px] md:max-w-[700px] aspect-square mx-auto my-10 md:my-16 select-none overflow-visible" translate="no">
      {/* Background Decorative Circles */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] md:w-[600px] md:h-[600px] rounded-full border border-gray-100 opacity-50 pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[190px] h-[190px] sm:w-[250px] sm:h-[250px] md:w-[400px] md:h-[400px] rounded-full border border-gray-50 opacity-50 pointer-events-none" />

      {/* Center Core */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center justify-center w-[110px] h-[110px] sm:w-[160px] sm:h-[160px] md:w-[220px] md:h-[220px] rounded-full bg-gradient-to-br from-brand-green to-brand-green-dark shadow-[0_12px_30px_rgba(22,163,74,0.3)] group">
      ...
      <div className="absolute top-[10%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center animate-fade-in-up" style={{ animationDelay: '100ms' }} suppressHydrationWarning>
        <div className="w-[82px] h-[82px] sm:w-[115px] sm:h-[115px] md:w-[150px] md:h-[150px] rounded-full bg-white/95 backdrop-blur-md border-double border-[3px] sm:border-[5px] md:border-[6px] border-brand-green/30 shadow-[0_6px_20px_rgba(0,0,0,0.06)] flex flex-col items-center justify-center transition-transform hover:scale-105">
      ...
      <div className="absolute top-[90%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center animate-fade-in-up" style={{ animationDelay: '300ms' }} suppressHydrationWarning>
        <div className="w-[82px] h-[82px] sm:w-[115px] sm:h-[115px] md:w-[150px] md:h-[150px] rounded-full bg-white/95 backdrop-blur-md border-double border-[3px] sm:border-[5px] md:border-[6px] border-brand-blue/30 shadow-[0_6px_20px_rgba(0,0,0,0.06)] flex flex-col items-center justify-center transition-transform hover:scale-105">
      ...
      <div className="absolute top-1/2 left-[10%] -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center animate-fade-in-up" style={{ animationDelay: '200ms' }} suppressHydrationWarning>
        <div className="w-[82px] h-[82px] sm:w-[115px] sm:h-[115px] md:w-[150px] md:h-[150px] rounded-full bg-white/95 backdrop-blur-md border-double border-[3px] sm:border-[5px] md:border-[6px] border-brand-cyan/40 shadow-[0_6px_20px_rgba(0,0,0,0.06)] flex flex-col items-center justify-center transition-transform hover:scale-105">
      ...
      <div className="absolute top-1/2 left-[90%] -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center animate-fade-in-up" style={{ animationDelay: '400ms' }} suppressHydrationWarning>
        <div className="w-[82px] h-[82px] sm:w-[115px] sm:h-[115px] md:w-[150px] md:h-[150px] rounded-full bg-white/95 backdrop-blur-md border-double border-[3px] sm:border-[5px] md:border-[6px] border-brand-teal/40 shadow-[0_6px_20px_rgba(0,0,0,0.06)] flex flex-col items-center justify-center transition-transform hover:scale-105">
        ...
        <g className="origin-center animate-[spin_40s_linear_infinite]">
          ...
          <g className="origin-center rotate-45">
            <svg x="50%" y="10%" overflow="visible">
              <path d="M -4,-4 L 4,0 L -4,4 L -2,0 Z" fill="#94a3b8" />
            </svg>
          </g>
          {/* 135 degrees */}
