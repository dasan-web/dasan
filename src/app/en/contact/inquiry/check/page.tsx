          ...
          <div className="lg:col-span-5 space-y-8 flex flex-col items-center w-full">
            ...
            <div className="pb-8 w-full text-center flex flex-col items-center">
              <div className="flex items-center justify-center space-x-2 text-xs font-bold uppercase tracking-widest text-brand-green mb-3">
                <span>{grandContact?.enName || grandContact?.name}</span>
            ...
            <div className="min-h-[550px] space-y-8 w-full max-w-5xl">
              <div className="text-left">
                <p className="text-sm text-gray-500 max-w-2xl leading-relaxed">
                  You can check the status of your inquiry by entering the email address you provided when submitting a product or sales inquiry.
                </p>
                <p className="text-xs text-brand-green/90 font-bold mt-2 leading-relaxed">
                  * For anonymous corruption reporting, you can check the submission status by entering the default inquiry email, <span className="underline">anonymous@dspharm.com</span>.
                </p>
              </div>
